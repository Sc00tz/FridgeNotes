#!/usr/bin/env python3
"""
Database cleanup and migration script for FridgeNotes
This script can be run manually to fix database schema issues
"""
...
def main():
    ...
    print("🔧 FridgeNotes Database Cleanup Tool")
    print("=" * 50)
    ...
    try:
        ...
        # Cleanup if needed
        if duplicates:
            response = input("🔄 Remove duplicate tables? (Y/n): ")
            if response.lower() != 'n':
